...
Please consider using HEC's official [hec-dss-r](https://github.com/HydrologicEngineeringCenter/hec-dss-r/) package under development, or the unofficial [dssrip2](https://github.com/mkoohafkan/dssrip2/) for a newer implementation that hides more of the Java API in a more R friendly format.
